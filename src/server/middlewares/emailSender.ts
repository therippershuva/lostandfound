 ...
 */
export const confirmEmailSender = async (
    req: Request,
    user: TUser,
    token: TToken,
) => {
 ...
 * @returns  {object} error
 */
export const emailVerifiedEmailSender = async (user: TUser) => {
    await verifyConnection();
 ...
 * @returns  {object} error
 */
export const resetPasswordEmailSender = async (
    req: Request,
    user: TUser,
    token: TToken,
) => {
 ...
 * @returns  {object} error
 */
export const deleteAccountEmailSender = async (
    req: Request,
    user: TUser,
    token: TToken,
) => {
